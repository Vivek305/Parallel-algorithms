...
make mergesort mergesort_seq

for n in $N;
do
    ./mergesort_seq $n  >/dev/null 2> ${RESULTDIR}/mergesort_${n}
    for t in $THREADS;
    do
...
set yrange [0:20];
set title 'n=$N';
plot '${RESULTDIR}/speedup_mergesort_${N}' u 1:(\$2/\$3) t 'Mergesort'
